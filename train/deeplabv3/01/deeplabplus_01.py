...
class SegmentationDataset(VisionDataset):
    ...
    def __getitem__(self, index: int) -> Any:
        ...
        with open(image_path, "rb") as image_file, open(mask_path,
            ...
            mask_arr =np.transpose(arr,(2,0,1)).astype(np.uint8)*255
            mask_arr[0]
            mask = Image.fromarray(mask_arr[0])
...
def get_dataloader_single_folder(data_dir: str,
                                ...
                                #  'mask_zero_to_three',# Plot the input image, ground truth and the predicted output',
    ...
    return dataloaders
data_directory='/home/fisher/Peoples/hseung/NUBchi/Training'
exp_directory='/home/fisher/Peoples/hseung/DeepLabV3Plus-Pytorch/exp'
...
torch.save(model, exp_directory / 'deeplabplus_01_crossentorpy.pt')